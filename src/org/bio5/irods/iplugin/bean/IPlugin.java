...
public class IPlugin implements Serializable {
	...
	/************************ Zhong Yang *************************/
	private boolean mainWindowStatus = false;
	
	private TreePath[] treePaths;
	
	private TASSELMainFrame tasselMainFrme = null;
	
	private IRodsFileLoadPlugin irodsFileLoadPlugin = null;
	// Using this method for avoid conflict when user use it in different menu in Tassel.
	public void setMainWindowStatus(boolean mainWindowStatus){
		this.mainWindowStatus = mainWindowStatus;
	}
	// Using this method for avoid conflict when user use it in different menu in Tassel.
	public boolean getMainWindowStatus(){
		return mainWindowStatus;
	}
	
	public void setTASSELMainFrame(TASSELMainFrame tasselMainFrame){
		this.tasselMainFrme = tasselMainFrame;
	}
	
	public TASSELMainFrame getTASSELMainFrame(){
		return tasselMainFrme;
	}
	...
	public void setIRodsFileLoadPlugin(IRodsFileLoadPlugin irodsFileLoadPlugin){
		this.irodsFileLoadPlugin = irodsFileLoadPlugin;
	}
	
	public IRodsFileLoadPlugin getIRodsFileLoadPlugin(){
		return irodsFileLoadPlugin;
	}
