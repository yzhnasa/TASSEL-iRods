...
public class MainWindow extends JFrame {
	...
	/************************** Zhong Yang ******************************/
	/*public void setWindowVisable(boolean visable){
	...
	private void loginMethod() {
		...
		String zone = comboBox_Zone.getSelectedItem().toString();
		{
			try {
				...
				show();
				/**************************** Zhong Yang *******************************/
				iplugin.setMainWindowStatus(true);
				if(visibleFlag == false){
					this.setVisible(false);
				}
				iplugin.getTASSELMainFrame().setLoadDataFromIRodsMenuItemEnable();
				/***********************************************************************/
			}
