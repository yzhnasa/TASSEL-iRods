 ...
 * @author Ed Buckler
 */
public class ImputationDialogPlugin2 extends AbstractPlugin {
    //JFXPanel jfxPanel = new JFXPanel();
    final JFXPanel fxPanel = new JFXPanel();
    private static List<PluginParameter> haplotypeParam=new ArrayList<>();
...
//        validateFields.put(hap_mxDiv,Range.closed(0.0,1.0));
    ...
    public ImputationDialogPlugin2(java.awt.Frame parentFrame, boolean isInteractive) {
    ...
    private void initFX(JDialog dialog) {
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    FXMLLoader fxmlLoader = new FXMLLoader(ImputationDialogPlugin2.class.getResource("ImputationDialog.fxml"));
                    fxmlLoader.setController(ImputationDialogPlugin2.this);
