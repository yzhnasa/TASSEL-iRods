...
class DataFilterAlignmentDialog extends JDialog {
    ...
    private void filterButton_actionPerformed(ActionEvent e) {
        ...
        } else if (startPos > theAlignment.getPositionInChromosome(siteCount - 1) && theAlignment.getNumLoci() == 1) {
        ...
        } else if (endPos < theAlignment.getPositionInChromosome(0) && theAlignment.getNumLoci() == 1) {
