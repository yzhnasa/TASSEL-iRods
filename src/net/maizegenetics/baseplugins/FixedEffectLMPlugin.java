...
public class FixedEffectLMPlugin extends AbstractPlugin {
	 ...
	 * @param seed 
	 */
	public void setRandomizer(long seed) { randomizer.setSeed(seed); }
    	...
    	GLMOptionsDialog(Frame parentFrame) {
    		...
    		chkPermute.addActionListener(new ActionListener(){
    			...
    			public void actionPerformed(ActionEvent evt) {
    				if (chkPermute.isSelected()) txtPermutationNumber.setEnabled(true);
    				else txtPermutationNumber.setEnabled(false);
    			}
    		});
