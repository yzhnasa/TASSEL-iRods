...
public class BitPhasedNucleotideAlignment extends BitPhasedAlignment {
    ...
    protected BitPhasedNucleotideAlignment(IdGroup idGroup, byte[][] data, GeneticMap map, byte[] reference, String[][] alleleStates, int[] variableSites, int maxNumAlleles, Chromosome[] loci, int[] lociOffsets, String[] snpIDs, boolean retainRareAlleles, boolean isSBit) {
    ...
    protected BitPhasedNucleotideAlignment(IdGroup idGroup, byte[][] alleles, BitSet[][] data0, BitSet[][] data1, GeneticMap map, byte[] reference, String[][] alleleStates, int[] variableSites, int maxNumAlleles, Chromosome[] loci, int[] lociOffsets, String[] snpIDs, boolean retainRareAlleles, boolean isSBit) {
