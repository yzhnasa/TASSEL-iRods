...
public class SBitTextAlignment extends SBitAlignment {
    ...
    protected SBitTextAlignment(Alignment a, int maxNumAlleles, boolean retainRareAlleles, boolean isFinalized) {
        super(a, maxNumAlleles, retainRareAlleles, isFinalized);
    }

    protected SBitTextAlignment(IdGroup idGroup, byte[][] data, GeneticMap map, byte[] reference, String[][] alleleStates, int[] variableSites, int maxNumAlleles, Locus[] loci, int[] lociOffsets, String[] snpIDs, boolean retainRareAlleles, boolean isFinalized) {
