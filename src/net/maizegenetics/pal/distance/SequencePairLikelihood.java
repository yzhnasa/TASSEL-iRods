...
//import net.maizegenetics.pal.datatype.AmbiguousDataType;
import net.maizegenetics.pal.datatype.DataType;
import net.maizegenetics.pal.math.UnivariateFunction;
 ...
 *
 * @version $Id: SequencePairLikelihood.java,v 1.1 2007/01/12 03:26:14 tcasstevens Exp $
 *
...
public class SequencePairLikelihood implements UnivariateFunction, java.io.Serializable {
    ...
    public void setSequences(int s1, int s2) {
        setSequences(sitePattern.getPattern()[s1], sitePattern.getPattern()[s2]);
    }
        ...
        for (int sequenceOneState = 0; sequenceOneState < numberOfSpecficStates; sequenceOneState++) {
            for (int sequenceTwoState = 0; sequenceTwoState < numberOfSpecficStates; sequenceTwoState++) {
                ...
                if (count > 0) {
                    ...
                    loglkl +=
                            count * (logEquilibriumFrequencies_[sequenceOneState] +
                            Math.log(total));
                }
            }
        }
