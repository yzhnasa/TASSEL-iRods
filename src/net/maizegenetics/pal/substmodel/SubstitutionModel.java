 ...
 *
 * @version $Id: SubstitutionModel.java,v 1.1 2007/01/12 03:26:16 tcasstevens Exp $
 *
...
//	public void removePalObjectListener(PalObjectListener l);
	...
	public static class Utils {
		 ...
		 * There is no independent distribution access (as rate distributions don't normally allow changing of probabilities for a category without changing the rate of a category - at least none in net.maizegenetics.pal do)
		 */
